import { ImageBox } from "../components/tools/ImageBox/ImageBox.jsx";
			...
			<div className="container about__container">
				...
				<div className="about__content">
					...
					<div className="about__descr">
						...
						<p>
							Я — пчеловод, экофермер и мастер на все руки
						</p>
					</div>
					<Swp className="about-text-slider">
						{about.map((item, i) => <div className="about-text-slider__slide about-text-slider-slide swiper-slide" key={i}><p className="about-text-slider-slide__text">{item.text}</p></div>)}
					</Swp>
					<div className="about__navigation">
						<button className="about__btn about__btn-prev" type="button">{btnPrev}</button>
						<div className="swiper-pagination pagination about__pagination "></div>
						<button className="about__btn about__btn-next" type="button">{btnNext}</button>
					</div>
				</div>
			</div>
		</section>
